...
### Multi-Provider-Proxy-Middleware für Claude Code CLI und Codex
...
AI Gateway (AIG) ist eine lokale Proxy-Middleware, die Claude Code CLI und OpenAI Codex CLI ohne Änderungen am Anwendungscode mit mehreren KI-Anbietern verbindet.

### Warum AI Gateway?

| Anforderung | AI-Gateway-Lösung |
|---|---|
| Die CLIs verwenden unterschiedliche APIs | Transparente Übersetzung zwischen Anthropic-, OpenAI- und konfigurierten Provider-Protokollen |

---

## Unterstützte Anbieter

AI Gateway unterstützt **17 Anbieter**: 14 Cloud-Dienste und 3 lokale Anbieter.
...
### Lokale Anbieter (ohne API-Schlüssel)
...
Anleitungen zu Konfiguration, Sicherheit und Betrieb finden Sie im [Haupt-README](README.md) und in [ARCHITECTURE.md](ARCHITECTURE.md).

---

## Lizenz

Veröffentlicht unter der MIT-Lizenz. Weitere Informationen in [LICENSE](LICENSE).

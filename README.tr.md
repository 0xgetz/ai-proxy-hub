...
### Claude Code CLI ve Codex için çok sağlayıcılı proxy ara katmanı
...
AI Gateway (AIG), uygulama kodunu değiştirmeden Claude Code CLI ve OpenAI Codex CLI'yi birden çok yapay zekâ sağlayıcısına bağlayan yerel bir proxy ara katmanıdır.

### Neden AI Gateway?

| İhtiyaç | AI Gateway çözümü |
|---|---|
| CLI'lar farklı API'ler kullanır | Anthropic, OpenAI ve yapılandırılmış sağlayıcı protokolleri arasında şeffaf çeviri |

---

## Desteklenen sağlayıcılar

AI Gateway, 14 bulut hizmeti ve 3 yerel sağlayıcı olmak üzere **17 sağlayıcıyı** destekler.
...
### Yerel sağlayıcılar (API anahtarı gerekmez)
...
Yapılandırma, güvenlik ve işletim talimatları için [ana README](README.md) ve [ARCHITECTURE.md](ARCHITECTURE.md) dosyalarına bakın.

---

## Lisans

MIT lisansı altında dağıtılır. Ayrıntılar için [LICENSE](LICENSE) dosyasına bakın.

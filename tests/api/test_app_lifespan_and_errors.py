...
def test_create_app_writes_server_log_under_aig_home(monkeypatch, tmp_path):
    """App logging uses ~/.aig/logs/server.log regardless of cwd."""
    ...
    assert canonical_log == tmp_path / ".aig" / "logs" / "server.log"

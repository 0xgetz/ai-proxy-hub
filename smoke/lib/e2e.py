...
class ProviderMatrixDriver:
    ...
    def provider_smoke_models(self) -> list[ProviderModel]:
        ...
        if not models and os.getenv("AIG_ALLOW_NO_PROVIDER_SMOKE") != "1":
            fail_missing_env(
                "no configured provider smoke models; set AIG_ALLOW_NO_PROVIDER_SMOKE=1 "
    ...
    def adaptive_thinking_payload() -> dict[str, Any]:
        return {
            ...
            "messages": [
                ...
                {"role": "user", "content": "Reply with exactly AIG_SMOKE_CLIENT"},
            ],

...
def test_provider_error_e2e(smoke_config: SmokeConfig) -> None:
    ...
    broken_model = f"{provider_model.provider}/aig-smoke-missing-model"
    with (
        SmokeServerDriver(
            smoke_config,
...
def _scenario_tool_result_continuation(
    ...
    first_payload = {
        ...
        "max_tokens": 256,
        "messages": [
            {"role": "user", "content": "Use echo_smoke once with value AIG_TOOL."}
        ],
        "tools": [echo_tool_schema()],

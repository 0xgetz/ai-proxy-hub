...
CAPABILITY_CONTRACTS: tuple[CapabilityContract, ...] = (
    CapabilityContract(
        ...
        "api.request_pipeline.ApiRequestPipeline",
    ...
    CapabilityContract(
        ...
        "api.request_pipeline.ApiRequestPipeline.create_response",
    ...
    CapabilityContract(
        ...
        "process env, user env file, repo env file, AIG_ENV_FILE",
    ...
    CapabilityContract(
        ...
        "drop_in_codex_replacement",
        "cli.launchers.codex",
        "Codex CLI binary and aig provider env",

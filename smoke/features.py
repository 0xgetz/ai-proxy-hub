...
FEATURE_INVENTORY: tuple[FeatureCoverage, ...] = (
    FeatureCoverage(
        ...
        "missing providers are missing_env unless AIG_ALLOW_NO_PROVIDER_SMOKE=1",
    ),
    FeatureCoverage(
        "drop_in_claude_code_replacement",
        ...
        (
            "configured provider",
            "AIG_SMOKE_CLAUDE_BIN for real Claude CLI",
            "NVIDIA_NIM_API_KEY",
            "OPENROUTER_API_KEY",
        ),
    ...
    FeatureCoverage(
        ...
        ("providers",),
        ("configured provider credentials/endpoints", "optional AIG_SMOKE_MODEL_*"),
    ...
    FeatureCoverage(
        ...
        ("messaging", "voice"),
        ("VOICE_NOTE_ENABLED", "AIG_SMOKE_RUN_VOICE", "WHISPER_DEVICE"),
    ...
    FeatureCoverage(
        ...
        ("tests/cli/test_entrypoints.py",),
        (
            "test_aig_init_scaffolds_user_config",
            "test_ai_gateway_entrypoint_starts_server",
        ),
    ...
    FeatureCoverage(
        ...
        "AIG_ENV_FILE, dotenv, and process env precedence are deterministic",
        "public_surface",

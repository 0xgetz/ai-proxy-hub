...
### Middleware de proxy multiprovedor para Claude Code CLI e Codex
...
O AI Gateway (AIG) é um middleware de proxy local que conecta o Claude Code CLI e o OpenAI Codex CLI a diversos provedores de IA sem exigir alterações no código da aplicação.

### Por que usar o AI Gateway?

| Necessidade | Solução do AI Gateway |
|---|---|
| As CLIs usam APIs diferentes | Tradução transparente entre os protocolos Anthropic, OpenAI e dos provedores configurados |

---

## Provedores compatíveis

O AI Gateway oferece suporte a **17 provedores**: 14 serviços em nuvem e 3 provedores locais.
...
### Provedores locais (sem chave de API)
...
Para instruções de configuração, segurança e operação, consulte o [README principal](README.md) e o [ARCHITECTURE.md](ARCHITECTURE.md).
